 ...
 * código reutilizable, toda llamada a la misma será enlazada ya sea   *
...
int main(void) {
     ...
     * por el compilador, con el simple hecho de dejar vacios los       *
    ...
    puts("\n\nValor de retorno de la función:\n");
    // Ejemplo 1: función llamada 'division' que recibe dos enteros y
    // regresa un doble.
    //
     ...
     *             la palabra static restringe la visivilidad de una    *
