...
// Funcion si_o_no que regresa las cadenas que corresponde
...
int main(int argc, const char * const * const argv) {
     ...
     * uno de ellos será convertido implicitamente al tipo de dato más  *
     * amplio.                                                          *
     * La jerarquía de conversión es aproximadamente la que siguie:     *
     *                                                                  *
     ...
     * casteos implicitos de enteros a apuntador (que viene a ser un    *
     ...
     * implicitas pero oviamente uno puede hacer casi cualquier         *
    ...
    // conversión implicita del 1 a 1.0.
    if ( 1 == 1.1 )
