...
int main(void) {
     ...
     *                                                                  *
     * A continuación el desgloce de los varios subtipos de de cada     *
     * clasificación.                                                   */
     ...
     *                                                                  *
     *      Nota: El signo de interrogaciOn despues del sufijo indica   *
     ...
     *  - Precision doble  /  64 bits - 15 decimales  -> double.
     *  - Precision quadruple / 128 bits  - 33 decimales -> long double.
     *                                                                  *
     ...
     * cual no se moveran a pesar de continuar haciendo operaciones     *
     ...
     *                                                                  *
     * Los errores de representación de este tipó de dato estan menos   *
     ...
     * mienstras que el signo de interrogaciOn nos informa que dicho   *
     ...
     * complejas estan formadas de dos valoles del tipo escogido, una   *
