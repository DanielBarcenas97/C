...
int main(void) {
    ...
    // Hagamos la declaraciOn de un apuntador 'const' y para un pequenio
    // experimento
    int a = 10;
    const int * apt = &a;
    ...
    int * restrict nuevo_dato = malloc(sizeof(int));
    ...
    *nuevo_dato = 100;
    ...
    int * otra_referencia_al_nuevo_dato = nuevo_dato;

    *otra_referencia_al_nuevo_dato = 20;
