/* =========================== *
 * Curso C PROTECO - 12/10/17  *
 * Sucesion de fibonacci       *
 * Descripcion:                *
 *  Diferentes mEtodos para    *
 *  calcular los tErminos de   *
 ...
 * un crecimiento exponencial que se sale de control facilmente.
 * Se usa un arreglo estAtico para recordar los nUmeros previamente
 * calculados para permitir incluso a la funciOn recursiva tener
